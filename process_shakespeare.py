...
parser.add_argument('--input_txt', default='tiny-shakespeare/tiny.txt')
parser.add_argument('--output_h5', default='tiny-shakespeare/tiny.h5')
parser.add_argument('--output_json', default='tiny-shakespeare/tiny.json')
parser.add_argument('--val_frac', type=float, default=0.1)
parser.add_argument('--test_frac', type=float, default=0.1)
parser.add_argument('--quiet', action='store_true')
parser.add_argument('--encoding', default='utf-8')
parser.add_argument('--load_processed', default=False)
...
if __name__ == '__main__':
    if not args.load_processed:
        ...
        with h5py.File(args.output_h5, 'r') as f:
            ...
            print('Shape of the validation set is : \n', X['val'].shape)
            print('Shape of the testing set is : \n', X['test'].shape)